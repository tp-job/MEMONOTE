          ...
          <div className="space-y-1">
            {filters.map((filter) => (
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-left transition-colors duration-150 ${activeFilter === filter.id
            ...
            <div className="space-y-1">
              {tags.map((tag) => (
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 rounded-lg text-left transition-colors duration-150 ${activeFilter === tag
                      ? 'bg-purple-50 text-purple-700'
                      : 'text-gray-700 hover:bg-gray-50'
                    }`}
                >
                  <div className={`w-3 h-3 rounded-full mr-3 ${tag === 'Personal' ? 'bg-orange-400' :
